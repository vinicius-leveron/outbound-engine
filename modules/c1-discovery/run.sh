#!/bin/bash
# ===========================================
# C1 DISCOVERY — Runner Script
# ===========================================
# Descobre escritorios de advocacia via Google Maps
# ===========================================

set -e

MODULE_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
LOG_FILE="${MODULE_DIR}/logs/c1-discovery_$(date +%Y-%m-%d_%H%M%S).log"

echo "======================================"
echo "C1 DISCOVERY (advocacia-tech)"
echo "======================================"
echo "Data: $(date)"
echo "Log: ${LOG_FILE}"
echo "======================================"
...
echo ""
echo "======================================"
echo "C1-Discovery finalizado. Log: ${LOG_FILE}"
echo "======================================"
